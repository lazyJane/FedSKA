from FLAlgorithms.users.userditto import UserDitto
    ...
    def __init__(self, args, model, data_participate, data_unseen, seed):
        ...
        if args.test_unseen == True:
            ...
            for task_id, (train_iterator, val_iterator, test_iterator, len_train, len_test) in \
                ...
                user = UserDitto(args, task_id, model, train_iterator, val_iterator, test_iterator, len_train, len_test, self.len_public, self.n_classes,  use_adam=False)
            ...
            print("Finished creating FedDitto server.")
    ...
    def train(self, args):
        ...
        for glob_iter in range(self.num_glob_iters):
            ...
            for user in self.selected_users: # allow selected users to train
                ...
                user.ptrain(glob_iter, personalized=self.personalized)
